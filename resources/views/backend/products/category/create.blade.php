          ...
          <div class="row">
            <div class="col-md-3">
              <label for="">Breed Type</label>
                <select name="category_type" class="form-control light-fields" required>
                    ...
                    <option value="3">PET PRODUCT</option>
                </select>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
              <div class="form-group pb-1">
                ...
                <input type="number" class="form-control light-fields" placeholder="Sort Order" required value="0" min="0" step="1" name="sort_order">
              </div>
            </div>
            <div class="col-md-6">
              <label for="">Short Description</label>
              <textarea name="short_description" class="form-control light-fields"></textarea>
            </div>
        </div>
      </div>
    </div>
