        ...
        <div class="block-content">
          <div class="row">
            <div class="form-group col-md-4 mb-2">
              ...
              <input type="text" name="title" class="form-control light-fields input-sm" id="page-title" placeholder="Product Name" required value="{{ ($data['title'])??'' }}">
              @csrf
            </div>
            <div class="form-group col-md-4 mb-2">
              <label class="form-label">Product Slug <span class="text-danger">*</span></label>
              <div class="slug-field">
                  <input type="text" name="slug" class="form-control light-fields input-sm" id="page-slug" placeholder="Product Slug" required value="{{ ($data['slug'])??'' }}">
