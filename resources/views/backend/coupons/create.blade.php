      ...
      <div class="block-content">
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="number" class="form-control" name="discount_value" value="{{old('discount_value')}}" required min="0" step="0.01">
          </div>
          <div class="col-md-4 mb-3">
          ...
          <div class="col-md-6 mb-3 d-flex align-items-end">
            <div>
              ...
              <label class="form-check form-switch me-3">
                <input class="form-check-input" type="checkbox" name="show_on_website" {{old('show_on_website')?'checked':''}}>
                <span class="form-check-label">Show on website</span>
              </label>
              <label class="form-check form-switch">
                <input class="form-check-input" type="checkbox" name="is_blocked" {{old('is_blocked')?'checked':''}}>
